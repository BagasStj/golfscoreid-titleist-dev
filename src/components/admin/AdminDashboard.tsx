...
import ScoringAndLeaderboard from "./ScoringAndLeaderboard";
...
export default function AdminDashboard() {
  ...
  void selectedTournamentId; // dipertahankan untuk setSelectedTournamentId via TournamentManagement
  ...
  const menuItems = [
    ...
    {
      id: "flights" as AdminView,
      label: "Flight Management",
      icon: Plane,
      color: "info",
    },
    {
      id: "players" as AdminView,
      label: "Players",
      icon: Users,
      color: "accent",
    },
  ...
  const renderContent = () => {
    switch (currentView) {
      ...
      case "tournaments":
        return (
          <TournamentManagement onSelectTournament={setSelectedTournamentId} />
        );
        ...
        <header className="h-14 bg-gradient-to-r from-[#2e2e2e] to-[#1a1a1a] border-b border-red-900/30 sticky top-0 z-20 flex items-center px-4 lg:px-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-400 hidden sm:block">
              ...
              {currentView === "courses" &&
                "Manage golf courses and hole configurations"}
              {currentView === "flights" &&
                "Manage tournament flights and player assignments"}
              {currentView === "players" && "Manage player registrations"}
              {currentView === "scoring" &&
                "Live scoring & tournament standings"}
              {currentView === "news" && "Manage news and announcements"}
              {currentView === "information" &&
                "Manage fact sheets, tee sheets, activities, and contacts"}
            </p>
          </div>
