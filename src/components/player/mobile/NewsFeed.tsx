...
type InformationItem = NonNullable<
  ReturnType<
    typeof useQuery<typeof api.information.getPublishedInformationForPlayer>
  >
>[number];
    ...
    <div className="px-4 py-4 space-y-5">
      ...
      <div className="bg-gradient-to-b from-[#2e2e2e] via-[#171718] to-black rounded-2xl p-5 shadow-xl border border-gray-800">
        ...
        <p className="text-gray-400 text-sm">
          Informasi General dan Tournament
        </p>
      </div>
            ...
            >
              ...
              <div className="p-4 pb-0">
                <div className="flex items-center gap-2 flex-wrap">
                  <div
                    className={`inline-flex items-center gap-2 ${getCategoryColor(item.category)} text-white text-xs font-semibold px-3 py-1.5 rounded-full shadow-lg`}
                  >
                  ...
                  {item.category === "tournament" && item.tournamentName && (
                    <div className="inline-flex items-center gap-1.5 bg-gradient-to-r from-amber-700 to-amber-800 text-white text-xs font-semibold px-3 py-1.5 rounded-full shadow-lg">
              ...
              <>
                ...
                {item.fileUrl && (
                  <div
                    className="relative h-48 overflow-hidden border-b border-gray-800 cursor-pointer group mt-3"
                    onClick={() =>
      ...
      {previewDialog && (
        ...
        >
          {/* Transparent area at top (click to close) */}
          ...
          {/* Transparent area at bottom (click to close) */}
